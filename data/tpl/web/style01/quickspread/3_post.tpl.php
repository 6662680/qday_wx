        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" id="url" name="url" class="form-control" value="<?php  echo $item['url'];?>"  />
                    </div>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="" name="qrleft" value="<?php  echo $item['qrleft'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">上边距</div>
                            <input type="text" class="form-control" placeholder="" name="qrtop" value="<?php  echo $item['qrtop'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">宽度</div>
                            <input type="text" class="form-control" placeholder="" name="qrwidth" value="<?php  echo $item['qrwidth'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">高度</div>
                            <input type="text" class="form-control" placeholder="" name="qrheight" value="<?php  echo $item['qrheight'];?>">
                            <div class="input-group-addon">px</div>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><label class="checkbox-inline" style="margin-top:-10px;"><input type="checkbox" name="avatarenable" value="1" <?php  if($item['avatarenable']) { ?> checked<?php  } ?>> 显示头像</label></div>
                            <div class="input-group-addon">左边距</div>
                            <input type="text" class="form-control" placeholder="" name="avatarleft" value="<?php  echo $item['avatarleft'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">上边距</div>
                            <input type="text" class="form-control" placeholder="" name="avatartop" value="<?php  echo $item['avatartop'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">宽度</div>
                            <input type="text" class="form-control" placeholder="" name="avatarwidth" value="<?php  echo $item['avatarwidth'];?>">
                             <div class="input-group-addon">px</div>
                            <div class="input-group-addon">高度</div>
                            <input type="text" class="form-control" placeholder="" name="avatarheight" value="<?php  echo $item['avatarheight'];?>">
                            <div class="input-group-addon">px</div>
                        </div>
                    </div>
                </div>
                   ...
                   <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">姓名</label>
                      <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><label class="checkbox-inline" style="margin-top:-10px;"><input type="checkbox" name="nameenable" value="1" <?php  if($item['nameenable']) { ?> checked<?php  } ?>> 显示姓名</label></div>
                            <div class="input-group-addon">左边距</div>
                            <input type="text" class="form-control" placeholder="" name="nameleft" value="<?php  echo $item['nameleft'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">上边距</div>
                            <input type="text" class="form-control" placeholder="" name="nametop" value="<?php  echo $item['nametop'];?>">
                            <div class="input-group-addon">px</div>
                            <div class="input-group-addon">字体大小</div>
                            <input type="text" class="form-control" placeholder="" name="namesize" value="<?php  echo $item['namesize'];?>">
                             <div class="input-group-addon">px</div>
                        </div>
                    </div>
                </div>
                    ...
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label"> <span class="red">*</span> 奖励详情(填入数字)</label>
                       <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="" name="newbie_credit" value="<?php  echo $item['newbie_credit'];?>">
                            <div class="input-group-addon">分</div>
                            
                            <div class="input-group-addon">推广奖励积分</div>
                            <input type="text" class="form-control" placeholder="" name="click_credit" value="<?php  echo $item['click_credit'];?>">
                            <div class="input-group-addon">分</div>
                            
                            <div class="input-group-addon">奖励上线积分</div>
                            <input type="text" class="form-control" placeholder="" name="sub_click_credit" value="<?php  echo $item['sub_click_credit'];?>">
                            <div class="input-group-addon">分</div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                            <input type="text" class="form-control" placeholder="" name="genqr_info1" value="<?php  echo $item['genqr_info1'];?>">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                            <input type="text" class="form-control" placeholder="" name="genqr_info2" value="<?php  echo $item['genqr_info2'];?>">
                    ...
                    <div class="col-sm-9 col-xs-12">
                         <input type="text" class="form-control" placeholder="" name="genqr_info3" value="<?php  echo $item['genqr_info3'];?>">
