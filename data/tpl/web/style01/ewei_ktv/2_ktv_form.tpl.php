...
<div class="main">
	<ul class="nav nav-tabs">
		<li <?php  if($op=='list' || empty($op)) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ktv',array('op'=>'list'));?>">ktv管理</a></li>
		<li <?php  if($op=='edit' && empty($item['id'])) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ktv',array('op'=>'edit'));?>">添加ktv</a></li>
		<?php  if($op=='edit' && !empty($item['id'])) { ?><li class="active"><a href="<?php  echo $this->createWebUrl('ktv', array('op'=>'edit','id'=>$id));?>">编辑ktv</a></li><?php  } ?>
	</ul>
	<form action="" class="form-horizontal form" method="post" enctype="multipart/form-data" onsubmit="return formcheck()">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv星级</label>
					<div class="col-sm-9 col-xs-12">
						<select class='form-control' id='level' name='level'>
							<option value=''>--请选择ktv星级--</option>
							<?php  if(is_array($ktv_level_config)) { foreach($ktv_level_config as $key => $value) { ?>
				...
				<div class="form-group">
					<label class="col-xs-12 col-md-2 control-label">ktv设施</label>
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv品牌</label>
					<div class="col-sm-9 col-xs-12">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv电话</label>
					<div class="col-sm-9 col-xs-12">
						<input type="text" id="phone" name="phone"  class="form-control" value="<?php  echo $item['phone'];?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv地址</label>
					<div class="col-sm-9 col-xs-12">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv商圈</label>
					<div class="col-sm-9 col-xs-12">
						<input type='hidden' id='businessid' name='businessid' value="<?php  echo $item['businessid'];?>" />
						<div class='input-group'>
							<input type="text" name="ktvbusiness" maxlength="30" value="<?php  echo $item['ktvbusinesss'];?>" id="ktvbusiness" class="form-control" readonly />
							<div class='input-group-btn'>
								<button class="btn btn-default" type="button" onclick="popwin = $('#modal-module-menus').modal();">ktv商圈</button>
							</div>
						</div>
						<div id="modal-module-menus"  class="modal fade" tabindex="-1">
							<div class="modal-dialog" style='width: 920px;'>
								<div class="modal-content">
									<div class="modal-header"><button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button><h3>ktv商圈</h3></div>
									<div class="modal-body" >
										<div class="row">
											<div class="input-group">
												<input type="text" class="form-control" name="keyword" value="" id="search-kwd" placeholder="请输入ktv商圈" />
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv坐标</label>
					<div class="col-sm-9 col-xs-12" style="padding-left:15px;">
						<?php  echo tpl_form_field_coordinate('baidumap',$item)?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">ktv介绍</label>
					<div class="col-sm-9 col-xs-12">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">ktv订房说明(选填)</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">ktv位置交通说明(选填)</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						...
						<div class="help-block">ktv促销信息(选填)</div>
					</div>
				</div>
				<div class="form-group">
...
<script type="text/javascript">
	...
	function formcheck() {
		if ($("#title").val().trim() == '') {
			Tip.focus("title", "请填写ktv名称!", "right");
			return false;
		}
		return true;
	}
