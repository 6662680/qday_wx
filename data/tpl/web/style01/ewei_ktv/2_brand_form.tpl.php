...
<div class="main">
	<ul class="nav nav-tabs">
		<li><a href="<?php  echo $this->createWebUrl('brand');?>">品牌列表</a></li>
		<li<?php  if($op=='edit' && empty($id)) { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('brand',array('op'=>'edit'));?>">添加品牌</a></li>
		<?php  if($op=='edit' && !empty($id)) { ?><li class="active"><a href="<?php  echo $this->createWebUrl('brand',array('op'=>'edit','id'=>$id));?>">编辑品牌</a></li><?php  } ?>
	</ul>
	<form action="" class="form-horizontal form" method="post" onsubmit="return formcheck()">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-xs-12 col-sm-3 col-md-2 control-label">品牌名</label>
					<div class="col-sm-9 col-xs-12">
