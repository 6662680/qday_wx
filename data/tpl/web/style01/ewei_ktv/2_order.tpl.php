	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form action="./index.php" method="get" class="form-horizontal" role="form">
				...
				<input type="hidden" name="ktvid" value="<?php  echo $ktv['id'];?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-4 col-xs-12">
						<input class="form-control" name="ktvtitle"  type="text" value="<?php  if(!empty($ktv)) { ?><?php  echo $ktv['title'];?><?php  } else { ?><?php  echo $_GPC['ktvtitle'];?><?php  } ?>" placeholder="ktv名称">
					</div>
					<div class="col-sm-4 col-xs-12">
	...
	<div class="panel panel-default">
		...
		<table class="table table-hover">
			...
			<tr>
				...
				<td><?php  echo $row['ktvtitle'];?></td>
				<td><?php  echo $row['roomtitle'];?></td>
				<td><?php  echo $row['name'];?>/<?php  echo $row['mobile'];?></td>
				...
				<td>
					<a href="<?php  echo $this->createWebUrl('order', array('op'=>'edit', 'id' => $row['id'], 'roomid' => $row['roomid'], 'ktvid' => $row['ktvid'])); ?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;
                    <a onclick="return confirm('此操作不可恢复，确认吗？');return false;" href="<?php  echo $this->createWebUrl('order', array('op'=>'delete', 'id' => $row['id'],'ktvid'=>$ktvid,'roomidid'=>$roomidid))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
				</td>
			</tr>
			<?php  } } ?>
			<tr>
