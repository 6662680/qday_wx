  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-2 control-label">参与活动强制提交资料</label>
          <div class="col-sm-2">
             <label><input type="radio" value="0" name="reg" <?php  if($reply['reg'] == 0 ) { ?>checked<?php  } ?>>否</label>
             <label><input type="radio" value="1" name="reg" <?php  if($reply['reg'] == 1 ) { ?>checked<?php  } ?>>是</label>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label class="col-xs-12 col-sm-3 col-md-2 control-label">奖品信息</label>
          <div class="col-sm-9">
            <textarea class="form-control" name="prizeinfo"><?php  echo $reply['prizeinfo'];?></textarea>
            <div class="help-block">活动页面的说明</div>
          </div>
        </div>
        <div class="form-group">
