				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline">
							<input type="radio" value="0" name="version" class="version" <?php  if($set['version']==0 || empty($set['version'])) { ?>checked<?php  } ?>/> 独立足浴版本
						</label>
						<label class="radio-inline">
							<input type="radio" value="1" name="version" class="version" <?php  if($set['version']==1) { ?>checked<?php  } ?>/> 多个足浴版本
						</label>
