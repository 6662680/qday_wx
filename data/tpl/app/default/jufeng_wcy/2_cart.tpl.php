...
<div class="dish-main">
    ...
    <div class="order-hd">
		<span class="pcate2name"><a href="<?php  echo $this->createMobileUrl('list',array('pcate'=>$_GPC['pcate'],'ccate'=>$_GPC['ccate']))?>">店家：<?php  echo $pcate2[0]['name'];?></a></span>
	</div>
		...
		<div class="order-detail-list">
			<ul class="list-unstyled">
				<?php  if(is_array($foods)) { foreach($foods as $item) { ?>
				<li>
					...
					<div class="pull-left">
                        ...
                        <?php  if($item['preprice']) { ?><?php  echo $item['preprice'];?><?php  } else { ?><?php  echo $item['oriprice'];?><?php  } ?></span>元<?php  if($item['unit']) { ?> / <?php  echo $item['unit'];?><?php  } ?>
                        </div>
					</div>
				</li>
				<?php  } } ?>
		...
		<form action="" method="post" onsubmit="return checkform(this); return false;">
			<table class="table table1">
                ...
                <tr>
					...
					<td><input type="text" id="" class="form-control1" name="address" value="<?php  echo $profile['address'];?>" /></td>
                    <td>*</td>
				</tr>
                 <tr>
