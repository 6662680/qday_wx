            ...
            <div class="sub-viewport" id="id_viewport2" page-id="212057" page-url="domestic/hotelorderdetail">
                <article class="p10" id="orderDetail">
                    <section class="cont_box_white">
                        <dl class="order_dl">
                            <dt>订单总额</dt>
                            <dd class="corange"><?php  echo $item['price'];?></dd>
                        </dl>
                        <dl class="order_dl">
                            <dt>订单状态</dt>
                            <dd>
                    ...
                    <section class="cont_box_white pos_rel" id='btns'>
                        <dl class="order_dl">
                            <form action="<?php  echo url('mc/cash/wechat', array('weid' => $_W['uniacid']), true);?>" method="post">
                                <input type="hidden" name="params" value="<?php  echo base64_encode(json_encode($params));?>" />
                                <button class="ui-btn-up-g"  type="submit" id="wBtn" value="wechat">微信支付(必须使用微信内置浏览器)</button>
                            </form>
                        ...
                        <ul class="line_li">
                            ...
                            <li>
                                <dl class="lmr_infobox">
                                    <dt>套餐项目</dt>
                                         <dd class="dl_m">
                                             <?php  if(is_array($itemList)) { foreach($itemList as $items) { ?>
                                                 <?php  echo $items;?>&nbsp;
                                             <?php  } } ?>
                                         </dd>
                                </dl>
                            ...
                            <li>
                                <dl class="lmr_infobox">
                                    <dt>足浴师</dt>
                                    <dd class="dl_m"><?php  echo $item['t_name'];?></dd>
                                </dl>
                            </li>
                        </ul>
                    </section>
