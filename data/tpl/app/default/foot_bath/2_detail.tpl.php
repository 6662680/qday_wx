...
<div id="ctripPage">
    ...
    <header>
        <h1 class="hoteltitle">情天连锁足浴中心</h1>
    ...
    <menu style="padding:10px">
        <div id="hotelpic">
            <div class="wrap">
                <dl class="topic-list">
                    <dt>共<span class="bold span1"><?php  echo $thumbscount;?></span>&nbsp;张</dt>
        ...
        <div id="checkinout">
            <div id="selinTime" onClick="location.href='<?php  echo $this->createMobileUrl('techni')?>'">
                <span class="ico_time"></span>选择足浴师&nbsp;&nbsp;&nbsp;&nbsp;<span id="CheckInDay"><?php  if(($t_list['name'] != '')) { ?><?php  echo $t_list['name'];?><?php  } ?></span>
                <span class="span2" id="CheckOutDay"><?php  if(($t_list['name'] != '')) { ?><?php  } ?></span><span
        ...
        <div class="conlist" style="width:100%; padding:0px; display:inline-block;">
            <ul class="ui-grid-b" id="menu">
                <li class="ui-block-a tab-click hover" id="liOrder">套餐预订</li>
                <!--<li class="ui-block-b" id="liDp">客户点评</li>-->
                <li class="ui-block-c tab-click" id="liMore">足浴中心</li>
            </ul>
                        ...
                        <li>
                            <div class="ui-grid-b roomlist" data-roomid="203806" data-index="0">
                                ...
                                <div class="ui-block-b" onclick="show_room_device('<?php  echo $item['hotelid'];?>','<?php  echo $item['id'];?>','<?php  echo $item['has'];?>','<?php  echo $item['price'];?>','<?php  echo $item['total_price'];?>')">
                                    <span data-paytype="1" class="bold"><?php  echo $item['p_name'];?></span><br>
                                    <span class="txt_gray">
                                        <?php  if(is_array($item['s_item'])) { foreach($item['s_item'] as $v) { ?>
                                              <span style="margin-right: 3px;"><?php  echo $v['item_name'];?></span>
                                        <?php  } } ?>
                                    </span><br>
                                ...
                                <div class="ui-block-c" data-fan="1" data-cny="RMB">
                                    ...
                                    <p class="room_btn" style='text-align:right;'>
                                        <input value="在线预订" class="ui-btn-order bookBtn" type="button"  style=" margin-bottom: 3px;width: 60px;-webkit-appearance: none;border-radius:0px;"
                                               onclick="location.href='<?php  echo $this->createMobileUrl('order', array('t_id' => $t_id, 'id' => $item['id'], 'price' => $item['price'], 'total_price' => $item['total_price']))?>'" >
