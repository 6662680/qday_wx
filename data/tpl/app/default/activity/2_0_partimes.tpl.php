				...
				<li class="list-group-item">
					<div class="con">
						...
						<div class="list-ft">
							...
							<div class="pull-right btns"><a href="<?php  echo url('activity/partimes/post', array('id' => $list['id']))?>">立即兑换</a></div>
						</div>
					</div>
				</li>
			<?php  } } ?>
...
<div class="btn-group-top-box">
	<div class="btn-group btn-group-top">
		<a href="<?php  echo url('activity/partimes/mine/', array('status' => '0'))?>" class="btn btn-default <?php  if(($_GPC['type'] != 'used')) { ?>active<?php  } ?>">待发货</a>
		<a href="<?php  echo url('activity/partimes/mine/', array('status' => '1'))?>" class="btn btn-default <?php  if(($_GPC['type'] == 'used')) { ?>active<?php  } ?>">已发货</a>
		<a href="<?php  echo url('activity/partimes/mine/', array('status' => '2'))?>" class="btn btn-default <?php  if(($_GPC['type'] == 'used')) { ?>active<?php  } ?>">已完成</a>
	</div>
</div>
<div class="panel">
	...
	<form name="theform" method="post" id="form1" action="">
		<ul class="nav nav-tabs">
			<li class="active"><a href="#basic">收货人信息</a></li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane animated active">
				...
				<div class="form-group">
					...
					<?php  echo tpl_fans_form('reside', array('province' => $ship['province'], 'city' => $ship['city'], 'district' => $ship['residedist']));?>
				</div>
				<div class="form-group">
...
<div class="voucher-main">
	<div class="btn-group-top-box">
		<div class="btn-group btn-group-top">
			<a href="<?php  echo url('activity/partimes/mine/', array('status' => '1'))?>" class="btn btn-default <?php  if(($_GPC['status'] == '1' || $_GPC['status'] == '')) { ?>active<?php  } ?>">已使用</a>
			<a href="<?php  echo url('activity/partimes/mine/', array('status' => '2'))?>" class="btn btn-default <?php  if(($_GPC['status'] == '2')) { ?>active<?php  } ?>">未使用</a>
		</div>
	</div>
	<div class="scroll-container">
		<div class="wrapper">
						...
						<div class="con">
							...
							<div class="list-ft">
								...
								<?php  if($list['status'] == 0) { ?>
									<div class="pull-right btns"><a href="<?php  echo url('activity/partimes/deliver', array('exid' => $list['exid']))?>">收货人信息</a></div>
								<?php  } else if($list['status'] == 1) { ?>
									<div class="pull-right btns"><a href="<?php  echo url('activity/partimes/confirm', array('exid' => $list['exid']))?>">确认收货</a></div>
								<?php  } else { ?>
