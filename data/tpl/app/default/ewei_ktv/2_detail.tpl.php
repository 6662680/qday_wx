...
<head>
    ...
    #ktvpic img, #room .ui-block-a img {
        background: rgba(0, 0, 0, 0.5) url(../addons/ewei_ktv/template/style/css/loading2.gif) 50% 50% no-repeat;
    }
    #ktvpic .wrap, #gallery .wrap {
        margin-left: 4px;
        white-space: nowrap;
    ...
    #ktvpic .topic-list, #gallery .topic-list {
        font-size: 16px;
    ...
    #mask .single img {
        width: 300px;
        background: #7D7A74 url(../addons/ewei_ktv/template/style/css/loading2.gif) 50% 50% no-repeat;
    ...
    .roomdetailinfo .ktv_fan, .roomdetailinfo .ktv_li, .roomdetailinfo .ktv_cu, .roomdetailinfo .ktv_quan {
        margin: 3px 5px 0 0;
    }
    .infotop {
        width: 100%;
...
<div id="ctripPage">
    ...
    <header>
        <h1 class="ktvtitle"><?php  echo $reply['title'];?></h1>
    ...
    <menu style="padding:10px">
                ...
                <dl class="topic-list">
                    ...
                    <dd index="0" des="<?php  echo $reply['title'];?>" alt="<?php  echo $reply['title'];?>">
                        <a href="<?php  echo tomedia($reply['thumb'])?>" rel="external">
                            <img src="<?php  echo tomedia($reply['thumb'])?>" id="ktvImgList" index="0" des="<?php  echo $reply['title'];?>" alt="<?php  echo $reply['title'];?>" />
                        </a>
                        <?php  if(is_array($thumbs)) { foreach($thumbs as $thumb) { ?>
                        <a href="<?php  echo tomedia($thumb)?>" rel="external">
                            <img id="ktvImgList" index="0" des="<?php  echo $reply['title'];?>" title="<?php  echo $reply['title'];?>" src="<?php  echo tomedia($thumb)?>" />
                        </a>
                        <?php  } } ?>
                    </dd>
                </dl>
        ...
        <div id="checkinout">
            <div id="selinTime" onClick="location.href='<?php  echo $this->createMobileUrl('date', array('hid' => $hid))?>'">
                <span class="ico_time"></span>预订日期&nbsp;<span id="CheckInDay"><?php  if(($search_array['bdate'] != '')) { ?><?php  echo $search_array['bdate'];?><?php  } else { ?>--<?php  } ?></span>
            </div>
        </div>
        ...
        <div class="conlist" style="width:100%; padding:0px; display:inline-block;">
            <ul class="ui-grid-b" id="menu">
                ...
                <li class="ui-block-c tab-click" id="liMore">ktv详情</li>
            </ul>
            <div id="content" style="padding:0px;">
                ...
                <ul id="detail">
                    <li>
                        <div class="conlist">
                            <div class="bold size16 hm" data-ktvdatatype="1"><?php  echo $reply['title'];?></div>
                            <?php  if(!empty($device)) { ?>
                            <div class="hotbluetip"><span>ktv设施</span></div>
                            ...
                            <div class="hotbluetip"><span>ktv介绍</span></div>
