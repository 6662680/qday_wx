...
<head>
    ...
    <link href="<?php  echo $this->_css_url?>ktv.css" rel="stylesheet"/>
...
<div id="main" class="h100">
    <div class="main-frame">
        <div class="main-viewport">
            <div class="sub-viewport" id="id_viewport2" page-id="212057" page-url="domestic/ktvorderdetail">
                <article class="p10" id="orderDetail">
                    ...
                    <?php  } ?>
                    <section class="myktvbox">
                        <h4 class="blue_tit">ktv信息</h4>
                        <ul class="line_li">
                            ...
                            <li>
                                ...
                                <dl class="lmr_infobox">
                                    <dt>预订时间</dt>
                                    <dd class="dl_m"><?php  echo date('m月d日',$item['btime'])?></dd>
                            ...
                            <li class="" id="js_ktv_tel" onclick="location.href='tel:<?php  echo $tel;?>'">电话: <?php  echo $tel;?><i class="newarr_r"></i></li>
                        </ul>
                    </section>
                    <section class="myktvbox">
                        ...
                        <ul class="lrlist">
                            <li>
                                <em>预订人</em><span><?php  echo $item['name'];?></span>
                            </li>
                            <li>
