            ...
            <div class="h100">
                ...
                <div class="conlist">
                    <div style="line-height: 25px;" id="des">
                        ...
                        <div>
                            <span class="bold">预订日期：<?php  echo $search_array['bdate'];?></span>
                        </div>
                        <div class="gray size12 bold spantop" id="show_room_num" style="color: red;display: none;">
                            <?php  if($list) { ?><?php  echo $list['date'];?>当天还有<?php  echo $list['num'];?>间空房,您的最大预定数量为<?php  echo $list['num'];?>间<?php  } else { ?>您的最大预定数量为<?php  echo $max_room;?>间<?php  } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="orderinfo">
                            ...
                            <div id="checkin-name">
                                <div class="ui-txt clear-input-box" data-d="1">
                                    <input type="text" id="uname" name="uname" value="<?php  echo $realname;?>" required="required" data-lid="0" class="checkin-name" placeholder="预订人（必填）">
