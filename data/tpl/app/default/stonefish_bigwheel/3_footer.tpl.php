<?php defined('IN_IA') or exit('Access Denied');?><link href="./resource/css/font-awesome.min.css" rel="stylesheet">
<style>
html,body,h1,h2,h3{font-family:"Microsoft YaHei UI", "微软雅黑", "宋体";}
...
.nav{padding-left:0;margin-bottom:0;list-style:none;font-size:12px;}
...
.nav-bardown{position:fixed; bottom:0; left:0; height:3.7em; overflow:hidden; background:#FCFCFC; border-top:1px solid #D5D5D5; width:100%; display:-webkit-box; display:-moz-box; display:box; -webkit-box-orient:horizontal; -moz-box-orient:horizontal; box-orient:horizontal; -webkit-box-sizing:border-box; -moz-box-sizing:border-box; box-sizing:border-box;}
...
.nav-bardown li a:hover{background-color:#FCFCFC;}
.nav-bardown i{display:block; font-size:2em; color:#9A9A9A;}
@-moz-document url-prefix(){.nav-bardown li{display:table-cell;width:1%;}}
.active span,.active i{color:#45C018;}
</style>
<ul class="nav nav-bardown nav-justified" style="z-index:10;">
	<li><a href="<?php  echo murl('entry//index',array('m'=>'stonefish_bigwheel','rid'=>$rid));?>" <?php  if($_GPC['do'] == 'index') { ?>class="active"<?php  } ?>><i class="fa fa-tachometer"></i> <span>抽奖</span></a></li>
	<li><a href="<?php  echo murl('entry//gift',array('m'=>'stonefish_bigwheel','rid'=>$rid));?>" <?php  if($_GPC['do'] == 'gift') { ?>class="active"<?php  } ?>><i class="fa fa-trophy"></i> <span>宝箱</span></a></li>
	<li><a href="<?php  echo murl('entry//rule',array('m'=>'stonefish_bigwheel','rid'=>$rid));?>" <?php  if($_GPC['do'] == 'rule') { ?>class="active"<?php  } ?>><i class="fa fa-volume-up"></i> <span>规则</span></a></li>
	<li><a href="<?php  echo murl('entry//awardinfo',array('m'=>'stonefish_bigwheel','rid'=>$rid));?>" <?php  if($_GPC['do'] == 'awardinfo') { ?>class="active"<?php  } ?>><i class="fa fa-gift"></i> <span>奖品</span></a></li>
</ul>