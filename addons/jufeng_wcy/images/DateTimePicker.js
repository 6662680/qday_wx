;(function ( $, window, document, undefined ) {
		...
		var defaults = {
			...
			titleContentDate: "请选择日期",
			titleContentTime: "请选择时间",
			titleContentDateTime: "请选择时间和日期",
		...
		DateTimePicker.prototype = {
			...
			_setVariablesForDate: function()
			{
				...
				if(dtPickerObj._compare(dtPickerObj.settings.mode, "time"))
				{
					...
					dtPickerObj.dataObject.iCurrentMinutes = dtPickerObj.dataObject.dCurrentDate.getMinutes() - dtPickerObj.dataObject.dCurrentDate.getMinutes()%15;
