...
function qp_D() {
    for (var a = 0; a < qp_d; a++) qp_c[qp_F][a].visible = !0, createjs.Tween.get(qp_c[qp_F][a]).to({
...
function qp_u() {
    ...
    if (0 == qipaApp.score) qipaShare.desc = qipaShare.title;
        ...
        99 < a && (a = "99.9");
        qipaShare.desc = "\u6211\u6570\u4e86\uffe5" + qipaApp.score + "\uff0c\u6bd4" + a + "%\u7684\u4eba\u6709\u94b1\uff01\u6211\u662f" + (5E3 > qipaApp.score ? "\u5c4c\u4e1d" : 1E4 > qipaApp.score ? "\u8d2b\u519c" : 15E3 > qipaApp.score ? "\u5bcc\u519c" : 2E4 > qipaApp.score ? "\u571f\u8c6a" :
            25E3 > qipaApp.score ? "\u7164\u8001\u677f" : "\u8d44\u672c\u5bb6") + "\u3002"
    }
}
var _cfg = {
    startFunc: qp_v,
    img: {
        ...
        manifest: [{
            src: "../addons/weiyun_shuqian/template/img/m0.png",
            id: "m0"
        }, {
            src: "../addons/weiyun_shuqian/template/img/mb0.png",
            id: "mb0"
        }, {
            src: "../addons/weiyun_shuqian/template/img/d0.png",
            id: "d0"
        }, {
            src: "../addons/weiyun_shuqian/template/img/starttip.png",
            id: "starttip"
        }, {
            src: "../addons/weiyun_shuqian/template/img/tmbg.png",
            id: "tmbg"
        }, {
            src: "../addons/weiyun_shuqian/template/img/splashtitle.png",
            id: "splashtitle"
        }, {
            src: "../addons/weiyun_shuqian/template/img/tmicon.png",
            id: "tmicon"
        }, {
            src: "../addons/weiyun_shuqian/template/img/start.png",
            id: "start"
        }, {
            src: "../addons/weiyun_shuqian/template/img/rank.png",
            id: "rank"
        }, {
            src: "../addons/weiyun_shuqian/template/img/share.png",
            id: "share"
        }, {
            src: "../addons/weiyun_shuqian/template/img/dlgbg.png",
            id: "dlgbg"
        }]
    },
    audio: {
        manifest: [{
            src: "../addons/weiyun_shuqian/template/audio/count.mp3",
            id: "count"
        }]
    }
};
