...
if (void 0 == APP_API_URL) var APP_API_URL = /localhost/.test(location.host) ? "http://localhost:8000/" : "";
...
(function(a, f) {
    ...
    a.onNewScore = function(b) {
        ENABLE_LB &&
        (b > a.best && (newRecord = !0, b > a.best && (a.best = b, a.storage.set(g, a.best))), b > SCORE_LIMIT && a.uploadScore(b))
    };
    a.storage = a.storage || {};
    ...
    a.newscore_wxoauth = function(b) {
        ...
        $.getJSON(b).done(function(b) {
            "wxoauth_needed" ==
            b.error ? qipaLog("upload score failed. wxoauth_needed.") : a.updateLoginInfo(b.pid, b.subscribed)
        })
    };
    ...
    a.leaderboard = function(b, a, c) {
        qipaLog(APP_API_URL + "leaderboard/" +
            a + "/" + c + "?callback=?");
