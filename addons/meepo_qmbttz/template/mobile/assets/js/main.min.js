...
function() {
    ...
    b = {
        ...
        shareDate: {
            ...
            link: "{$setting['share_url']}?timer=" + a,
...
function() {
    ...
    function() {
        ...
        window.weixinAPI.shareDate = Config.shareDate, window.weixinAPI.init())
...
function() {
    ...
    var a = {
        ...
        initEvent: function() {
            ...
            if (!this.inited) {
                ...
                function() {
                    ...
                    b && (_czc.push(["_trackEvent", "选择性别", "m" == b ? "男": "女"]), a.sex = b, Config.$el.d_over_role.find("img").attr("src", "../addons/meepo_qmbttz/template/mobile/assets/img/" + b + ".png"), $(".role").addClass("role-" + b), Config.$el.d_sex.hide())
                ...
                function() {
                    ...
                    b && c && d ? (Config.$el.share.show(), window.weixinAPI && (window.weixinAPI.showOptionMenu(), window.weixinAPI.shareDate.desc = "我挑战" + a.score + "升冰水,【" + b + "," + c + "," + d + "】快来挑战!关注ALS,传播公益.")) : alert("请点名3位好友")
        ...
        crazyTap: function() {
            ...
            this.enable && (this.playing || this.tick(), Config.$el.score.text(++this.score + "升"), Config.$el.water.height(this.score))
        ...
        gameOver: function() {
            ...
            window.weixinAPI && (window.weixinAPI.shareDate.desc = "我挑战" + this.score + "升冰水,你也来挑战吧!关注ALS,传播公益.");
            ...
            this.animTimer = setInterval(function() {
                ...
                1e3), void clearInterval(b.animTimer)) : void Config.$el.bucket.css("background-image", "url(../addons/meepo_qmbttz/template/mobile/assets/assets/img/b" + a + ".png)")
        ...
        reset: function() {
            ...
            Config.$el.bucket.hide().css("background-image", "url(../addons/meepo_qmbttz/template/mobile/assets/assets/img/b1.png)"),

            window.weixinAPI && (window.weixinAPI.shareDate = Config.shareDate)
