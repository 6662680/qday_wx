...
class JSSDK
{
    ...
    private function getJsApiTicket()
    {
        ...
        $data = cache_load("zombie.flight.jsapi_ticket.json::" . $this->weid, true);
        ...
        if (empty($data['expire_time']) || $data['expire_time'] < time() || $new) {
            ...
            if ($ticket) {
                ...
                cache_write("zombie.flight.jsapi_ticket.json::" . $this->weid, iserializer($data));
