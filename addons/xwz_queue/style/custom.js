$(function() {
    ...
    function b(u) {
        ...
        t = '<div class="header"><p class="header-name">' + g + '</p></div><div class="number"><p class="number-nub">' + u.data.type + u.data.number + '</p><p class="number-class">' + u.data.type_name + '</p><p id="number-before" class="number-before">' + r + '</p></div><p class="class-list-line"></p><div class="class-list"><div class="number-con"><p class="number-info first clearfix"><span class="fl">取号时间</span><span class="fr">' + u.data.dt_add + '</span></p><p class="number-info clearfix"><span class="fl">已等待</span><span id="wait-time" class="fr">' + u.data.waiting_time + '分钟</span></p><p class="number-info end clearfix"><span class="fl">商家电话</span><span class="fr"><a href="tel:' + l + '">' + l + '</a></span></p></div></div><div class="shop-info">' + s + '</div><div class="bottom-but">' + v + "</div>";
        $("#page2").html("").append(t);
        $("#page2").scrollTop(0, 0);
        m(0);
