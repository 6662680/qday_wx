...
#yanzheng .top{ height:30px; line-height:30px; padding:0 10px; background:url(http://img.ccoo.cn/wx/vote/images/bg_x1.png) repeat-x 0px 0; background-size:auto 100%; color:#fff; margin-bottom:10px;border-radius:3px;}\
#yanzheng .down{ width:90%; margin:0 auto;}\
.yibu{ background:url(http://img.ccoo.cn/wx/vote/images/quxiao.png) no-repeat 0px 5px; background-size:23px auto; padding-left:24px; height:30px; display:inline-block;}\
.quxiao{ width:23px; height:26px; float:right;  background:url(http://img.ccoo.cn/wx/vote/images/quxiao.png) no-repeat 0px -31px; background-size:21px;}\
